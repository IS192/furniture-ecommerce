    ...
    <Container>
      <Row>
        ...
        <div className="logo">
          ...
          Furniture App - ваш идеальный интернет-магазин мебели! Мы предлагаем широкий ассортимент качественной мебели для всех комнат вашего дома по доступным ценам.
          </p>
        </Col>
